...
class MaterialController extends Controller
{
	public function create(Request $request)
	{
		...
		return view('UI.carvings.customOrders.signs.houses.material',compact('carving'));
	}
	...
	public function store(Request $request)
	{
		...
		return redirect()->route('carvings.customOrder.sign.house.pattern.create',compact('carving'));
	}
