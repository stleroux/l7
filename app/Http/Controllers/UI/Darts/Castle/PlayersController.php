...
namespace App\Http\Controllers\UI\Darts\Castle;
...
##################################################################################################################
   public function index($gameID)
   {
      ...
      // dd($pies);
      $players = castlePlayers($gameID);

      // return view('UI.darts.castle.players.index', compact('game','pies', 'pies_1', 'pies_2', 'pies_3','players'));
      return view('UI.darts.castle.players.index', compact('game','pies','players'));
   }
