...
##################################################################################################################
   public function index($gameID)
   {
      ...
      $twenty_1_count_plus = DartsScore::where('team_id',1)->where('score',20)->where('game_id',$game->id)->count();
      $twenty_1_count_minus = DartsScore::where('team_id',1)->where('score',-20)->where('game_id',$game->id)->count();
      ...
      $nineteen_1_count_plus = DartsScore::where('team_id',1)->where('score',19)->where('game_id',$game->id)->count();
      $nineteen_1_count_minus = DartsScore::where('team_id',1)->where('score',-19)->where('game_id',$game->id)->count();
      ...
      $eighteen_1_count_plus = DartsScore::where('team_id',1)->where('score',18)->where('game_id',$game->id)->count();
      $eighteen_1_count_minus = DartsScore::where('team_id',1)->where('score',-18)->where('game_id',$game->id)->count();
      ...
      $seventeen_1_count_plus = DartsScore::where('team_id',1)->where('score',17)->where('game_id',$game->id)->count();
      $seventeen_1_count_minus = DartsScore::where('team_id',1)->where('score',-17)->where('game_id',$game->id)->count();
      ...
      $sixteen_1_count_plus = DartsScore::where('team_id',1)->where('score',16)->where('game_id',$game->id)->count();
      $sixteen_1_count_minus = DartsScore::where('team_id',1)->where('score',-16)->where('game_id',$game->id)->count();
      ...
      $fifteen_1_count_plus = DartsScore::where('team_id',1)->where('score',15)->where('game_id',$game->id)->count();
      $fifteen_1_count_minus = DartsScore::where('team_id',1)->where('score',-15)->where('game_id',$game->id)->count();
      ...
      $bull_1_count_plus = DartsScore::where('team_id',1)->where('score',25)->where('game_id',$game->id)->count();
      $bull_1_count_minus = DartsScore::where('team_id',1)->where('score',-25)->where('game_id',$game->id)->count();
      ...
      $twenty_2_count_plus = DartsScore::where('team_id',2)->where('score',20)->where('game_id',$game->id)->count();
      $twenty_2_count_minus = DartsScore::where('team_id',2)->where('score',-20)->where('game_id',$game->id)->count();
      ...
      $nineteen_2_count_plus = DartsScore::where('team_id',2)->where('score',19)->where('game_id',$game->id)->count();
      $nineteen_2_count_minus = DartsScore::where('team_id',2)->where('score',-19)->where('game_id',$game->id)->count();
      ...
      $eighteen_2_count_plus = DartsScore::where('team_id',2)->where('score',18)->where('game_id',$game->id)->count();
      $eighteen_2_count_minus = DartsScore::where('team_id',2)->where('score',-18)->where('game_id',$game->id)->count();
      ...
      $seventeen_2_count_plus = DartsScore::where('team_id',2)->where('score',17)->where('game_id',$game->id)->count();
      $seventeen_2_count_minus = DartsScore::where('team_id',2)->where('score',-17)->where('game_id',$game->id)->count();
      ...
      $sixteen_2_count_plus = DartsScore::where('team_id',2)->where('score',16)->where('game_id',$game->id)->count();
      $sixteen_2_count_minus = DartsScore::where('team_id',2)->where('score',-16)->where('game_id',$game->id)->count();
      ...
      $fifteen_2_count_plus = DartsScore::where('team_id',2)->where('score',15)->where('game_id',$game->id)->count();
      $fifteen_2_count_minus = DartsScore::where('team_id',2)->where('score',-15)->where('game_id',$game->id)->count();
      ...
      $bull_2_count_plus = DartsScore::where('team_id',2)->where('score',25)->where('game_id',$game->id)->count();
      $bull_2_count_minus = DartsScore::where('team_id',2)->where('score',-25)->where('game_id',$game->id)->count();
      ...
      return view('UI.darts.cricket.teams.index', compact(
         'game',
