...
#  ██║██║ ╚═╝ ██║██║     ╚██████╔╝██║  ██║   ██║   
#  ╚═╝╚═╝     ╚═╝╚═╝      ╚═════╝ ╚═╝  ╚═╝   ╚═╝   
# Show the form for importing entries to storage.
##################################################################################################################
   ...
   public function store(Request $request)
   {
      ...
      if($request->part === 'main')
      {
         ...
         $category = new Category;
            ...
            $category->name = ucwords($request->mName);
      ...
      if($request->part === 'sub')
      {
         ...
         $category = new Category;
            ...
            $category->name = ucwords($request->sName);
      ...
      if($request->part === 'category')
      {
         ...
         $category = new Category;
            ...
            $category->name = ucwords($request->cName);
