...
##################################################################################################################
   public function create($id = null)
   {
      ...
      if($id){
         ...
         return view('admin.invoicer.estimates.create.create', compact('products','clients','client'));
      }

      return view('admin.invoicer.estimates.create.create', compact('products','clients'));
...
##################################################################################################################
   public function destroy($id)
   {
      ...
      return redirect()->route('admin.invoicer.estimates')->with($notification);
   }
...
##################################################################################################################
   public function edit($id)
   {
      ...
      return view('admin.invoicer.estimates.edit.edit', compact('invoice','clients'));
   }
...
##################################################################################################################
   public function index() // All invoices
   {
      ...
      return view('admin.invoicer.estimates.index.index', compact('invoices'));
   }
...
##################################################################################################################
   public function quotes()
   {
      ...
      return view('admin.invoicer.invoices.index.quotes', compact('invoices'));
   }
...
##################################################################################################################
   public function invoiced()
   {
      ...
      return view('admin.invoicer.invoices.index.invoiced', compact('invoices'));
   }
...
##################################################################################################################
   public function estimates()
   {
      ...
      return view('admin.invoicer.invoices.index.estimates', compact('invoices'));
   }
...
##################################################################################################################
   public function paid()
   {
      ...
      return view('admin.invoicer.invoices.index.paid', compact('invoices'));
   }
...
##################################################################################################################
   public function show($id)
   {
      ...
      return view('admin.invoicer.estimates.show.show', compact('invoice','audits'));
   }
...
##################################################################################################################
   public function store(Request $request)
   {
      ...
      //       return redirect()->route('admin.invoicer.invoices.quotes')->with($notification);
      // }
