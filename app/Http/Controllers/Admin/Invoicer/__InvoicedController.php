...
##################################################################################################################
   public function create($id = null)
   {
      ...
      if($id){
         ...
         return view('admin.invoicer.invoiced.create.create', compact('products','clients','client'));
      }

      return view('admin.invoicer.invoiced.create.create', compact('products','clients'));
...
##################################################################################################################
   public function destroy($id)
   {
      ...
      return redirect()->route('admin.invoicer.invoiced')->with($notification);
   }
...
##################################################################################################################
   public function edit($id)
   {
      ...
      return view('admin.invoicer.invoiced.edit.edit', compact('invoice','clients'));
   }
...
##################################################################################################################
   public function index() // All invoices
   {
      ...
      return view('admin.invoicer.invoiced.index.index', compact('invoices'));
   }
...
##################################################################################################################
   public function show($id)
   {
      ...
      return view('admin.invoicer.invoiced.show.show', compact('invoice','audits'));
   }
