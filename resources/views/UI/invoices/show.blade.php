...
<div class="float-right">
   ...
   <a href="{{ route('myInvoices') }}" class="btn btn-primary no-print">Back</a>
</div>
      ...
      <td colspan="6" valign="top">
         <table width="100%" cellspacing="0" cellpadding="0" border="0">
            <tr>
               ...
               <td width="50%" class="text-center">{{ $invoice->id }}</td>
            </tr>
            <tr>
               <th width="50%" class="text-right">Invoice Date</th>
               <td width="50%" class="text-center">{{ $invoice->invoiced_at }}</td>
            </tr>
            <tr>
               <th width="50%" class="text-right">Paid Date</th>
               <td width="50%" class="text-center">{{ $invoice->paid_at }}</td>
            </tr>
         </table>
      </td>
   </tr>
      ...
      <td colspan="12">
         <table width="100%" cellspacing="0" cellpadding="0" border="0">
            <tr>
               ...
               <td width="20%" class="text-right">{{ ($invoice->amount_charged ? number_format($invoice->amount_charged, 2, '.', ' ') : '0.00') }}$</td>
            </tr>
            <tr>
               <th width="80%" class="text-right">HST</th>
               <td width="20%" class="text-right">{{ number_format($invoice->hst, 2, '.', ' ') }}$</td>
            </tr>
            <tr>
               <th width="80%" class="text-right">Discount</th>
               <td width="20%" class="text-right">{{ number_format($invoice->discounts, 2, '.', ' ') }}$</td>
            </tr>
            <tr>
               <th width="80%" class="text-right">Deposit</th>
               <td width="20%" class="text-right">{{ number_format($invoice->deposits, 2, '.', ' ') }}$</td>
            </tr>
            <tr>
               <th width="80%" class="text-right">Payments</th>
               <td width="20%" class="text-right">{{ number_format($invoice->payments, 2, '.', ' ') }}$</td>
            </tr>
            <tr>
               <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
               ...
               <td width="20%" class="text-right">{{ number_format($invoice->total, 2, '.', ' ') }}$</td>
            </tr>
         </table>
      </td>
   </tr>
