...
@section ('content')
	...
	<div class="card">
		...
		<div class="card-header">
			<span class="h2">{{ ucwords($recipe->title) }}</span>
			<span class="float-right">
				<div class="btn-group">
					@include('UI.recipes.buttons.printPrevious', ['size'=>'sm'])
					@include('UI.recipes.buttons.print2', ['size'=>'sm'])
				</div>
			</span>
		</div>
		...
		<div class="card-body">
			<div class="row">
				<div class="col-xs-12 col-sm-8">
					<div class="card mb-2">
						<div class="card-header bg-dark">Ingredients</div>
						<div class="card-body">
				...
				<div class="col-xs-12 col-sm-4">
					<div class="card mb-2">
						<div class="card-header bg-dark">Image</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-8">
					<div class="card mb-2">
						<div class="card-header bg-dark">Methodology</div>
						<div class="card-body">
							{!! $methodology = str_replace(array('<p>','</p>'),array('','<br />'),$recipe->methodology) !!}<br />
						</div>
					</div>
					<div class="card" style="margin-bottom: 0px">
						<div class="card-header bg-dark">Notes</div>
						<div class="card-body">
				...
				<div class="col-xs-12 col-sm-4">
					<div class="card mb-2">
						<div class="card-header bg-dark">Information</div>
						<div class="card-body">
							<table width="100%">
								<tr>
									<th>Category</th>
