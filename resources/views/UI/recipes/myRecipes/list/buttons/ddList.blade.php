<div class="btn-group" style="background-color: #800000">
	...
	@foreach ($categories as $category)
			<a class="dropdown-item p-0 pl-2 text-light" href="{{ route('recipes.myRecipesList', $category->name) }}">
				{{  deliciousCamelcase(ucfirst($category->name)) }}
			</a>
			@foreach ($category->children as $children)
				<a class="dropdown-item card-trans-6 p-0 pl-2" href="{!! route('recipes.myRecipesList', $children->name) !!}">
