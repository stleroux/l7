   ...
   <div class="row pb-2">
      <div class="col">
         <span class="float-right">
            ...
            <div class="btn-group">
               <a href="{{ route('recipes.favoriteRecipesGrid', 'all') }}" class="btn btn-sm btn-default">
                  <i class="{{ Config::get('icons.grid') }}"></i>
                  Grid
               </a>
               <a href="{{ route('recipes.favoriteRecipesList', 'all') }}" class="btn btn-sm btn-steel">
   ...
   <div class="card card-trans-2 mb-3 text-light">
      @if($recipes->count() > 0)
         <div class="card-body card-trans-2 p-2">
            {{-- @include('UI.recipes.myRecipes.alphabet.list') --}}
