   ...
   <div class="row pb-2">
      <div class="col">
         <span class="float-right">
         	{{-- <div class="btn-group">
					@include('UI.recipes.favoriteRecipes.buttons.grid', ['size'=>'sm', 'btn_label'=>'My Recipes'])
					@include('UI.recipes.favoriteRecipes.buttons.ddGrid', ['size'=>'sm'])
					@include('UI.recipes.buttons.printAll', ['size'=>'sm', 'btn_label'=>'Print All'])
					<!-- @include('admin.recipes.buttons.add', ['size'=>'sm']) -->
				</div> --}}
            <div class="btn-group">
               <a href="{{ route('recipes.favoriteRecipesGrid', 'all') }}" class="btn btn-sm btn-steel">
                  <i class="{{ Config::get('icons.grid') }}"></i>
                  Grid
               </a>
               <a href="{{ route('recipes.favoriteRecipesList', 'all') }}" class="btn btn-sm btn-default">
   ...
   <div class="card mb-3 card-trans-2">
		@if($recipes->count() > 0)
			<div class="card-body section_body p-1">
				<div class="my-1">
					{{-- @include('UI.recipes.favoriteRecipes.alphabet.grid') --}}
				</div>
								...
								<div class="card-text pb-1 m-0">
									<div class="align-self-end text-center">
										{{-- @if(!$recipe->isFavorited()) --}}
											@include('UI.recipes.favoriteRecipes.buttons.favorite', ['size'=>'xs'])
										{{-- @else --}}
