<div class="btn-group">
	...
	@foreach ($categories as $category)
			<a class="dropdown-item p-0 pl-2 text-warning" href="{{ route('recipes.indexGrid', $category->name) }}">
				{{  deliciousCamelcase(ucfirst($category->name)) }}
			</a>
			@foreach ($category->children as $children)
				<a class="dropdown-item p-0 pl-2" href="{!! route('recipes.indexGrid', $children->name) !!}">
