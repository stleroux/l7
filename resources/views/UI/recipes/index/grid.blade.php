	...
	<div class="row pb-2">
		<div class="col">
			<span class="float-right">
				<div class="btn-group">
					@include('UI.recipes.index.buttons.grid', ['size'=>'sm', 'btn_label'=>'All Recipes'])
					@include('UI.recipes.index.buttons.ddGrid', ['size'=>'sm'])
...
{{-- 	</div>
   ...
   <div class="row pb-2"> --}}
      {{-- <div class="col"> --}}
         {{-- <span class="float-right"> --}}
            <div class="btn-group">
               <a href="{{ route('recipes.indexGrid', 'all') }}" class="btn btn-sm btn-steel">
                  <i class="{{ Config::get('icons.grid') }}"></i>
                  Grid
               </a>
               <a href="{{ route('recipes.indexList', 'all') }}" class="btn btn-sm btn-default">
...
{{-- 		<div class="card-header section_header p-2">
		...
		@if($recipes->count() > 0)
			<div class="card-body section_body p-1">
				<div class="my-1">
					@include('UI.recipes.index.alphabet.grid')
				</div>
