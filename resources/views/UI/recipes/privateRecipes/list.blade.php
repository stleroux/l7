   ...
   <div class="row pb-2">
      <div class="col">
         <span class="float-right">
            <div class="btn-group">
               @include('UI.recipes.privateRecipes.buttons.list', ['size'=>'sm', 'btn_label'=>'Private Recipes'])
               @include('UI.recipes.privateRecipes.buttons.ddList', ['size'=>'sm'])
               @include('UI.recipes.buttons.printAll', ['size'=>'sm', 'btn_label'=>'Print All'])
               {{-- @include('admin.recipes.buttons.add', ['size'=>'sm']) --}}
            </div>
            <div class="btn-group">
               <a href="{{ route('recipes.privateRecipesGrid', 'all') }}" class="btn btn-sm btn-default">
                  <i class="{{ Config::get('icons.grid') }}"></i>
                  Grid
               </a>
               <a href="{{ route('recipes.privateRecipesList', 'all') }}" class="btn btn-sm btn-steel">
   ...
   <div class="card card-trans-2 mb-3 text-light">
      @if($recipes->count() > 0)
         <div class="card-body card-trans-2 p-2">
            @include('UI.recipes.privateRecipes.alphabet.list')
