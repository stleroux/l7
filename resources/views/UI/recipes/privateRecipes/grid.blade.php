   ...
   <div class="row pb-2">
      <div class="col">
         <span class="float-right">
         	<div class="btn-group">
					@include('UI.recipes.privateRecipes.buttons.grid', ['size'=>'sm', 'btn_label'=>'Private Recipes'])
					@include('UI.recipes.privateRecipes.buttons.ddGrid', ['size'=>'sm'])
					@include('UI.recipes.buttons.printAll', ['size'=>'sm', 'btn_label'=>'Print All'])
					{{-- @include('admin.recipes.buttons.add', ['size'=>'sm']) --}}
				</div>
            <div class="btn-group">
               <a href="{{ route('recipes.privateRecipesGrid', 'all') }}" class="btn btn-sm btn-steel">
                  <i class="{{ Config::get('icons.grid') }}"></i>
                  Grid
               </a>
               <a href="{{ route('recipes.privateRecipesList', 'all') }}" class="btn btn-sm btn-default">
   ...
   <div class="card mb-3 card-trans-2">
   	@if($recipes->count() > 0)
			<div class="card-body section_body p-1">
				<div class="my-1">
					@include('UI.recipes.privateRecipes.alphabet.grid')
				</div>
