   ...
   <div class="row pb-2">
      <div class="col">
         <span class="float-right">
         	<div class="btn-group">
					@include('UI.recipes.privateRecipes.grid.buttons.grid', ['size'=>'sm', 'btn_label'=>'Private Recipes'])
					@include('UI.recipes.privateRecipes.grid.buttons.ddGrid', ['size'=>'sm'])
   ...
   <div class="card mb-3 card-trans-2">
   	@if($recipes->count() > 0)
			<div class="card-body section_body p-1">
				<div class="my-1">
					@include('UI.recipes.privateRecipes.grid.alphabet')
				</div>
								...
								<div class="card-text pb-1 m-0">
									<div class="align-self-end text-center">
										{{-- @if(!$recipe->isFavorited()) --}}
											@include('UI.recipes.privateRecipes.grid.buttons.privatize', ['size'=>'sm'])
										{{-- @else --}}
