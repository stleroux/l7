      ...
      <div class="modal-content">
         ...
         <form action="" method="POST" id="restoreForm">
            ...
            <div class="modal-body text-dark">
               <p class="font-weight-bold">Are you sure you want to restore this {{ ucfirst($modelName) }}?</p>
               {{-- <p class="small font-weight-bold text-danger">This action CANNOT be reverted.</p> --}}
            </div>
            
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
               <button type="submit" class="btn btn-primary">Restore {{ ucfirst($modelName) }}</button>
            </div>
         </form>
