<div class="card card-primary">
   ...
   <div class="card-body p-1">
      ...
      {{-- @if(Route::currentRouteName() == 'admin.materials.index') --}}
         @can('material-create')
            <a href="{{ route('admin.materials.create') }}" class="btn btn-block btn-outline-success" title="Create Material">
      ...
      @if(Route::currentRouteName() == 'admin.materials.index')
         <form action="{{ route('admin.materials.mass_destroy') }}" method="post" class="">
            @csrf
            @method('DELETE')
      ...
      @if(Route::currentRouteName() == 'admin.materials.trashed')
         ...
         <form action="{{ route('admin.materials.mass_delete') }}" method="post" class="">
            @csrf
            @method('DELETE')
