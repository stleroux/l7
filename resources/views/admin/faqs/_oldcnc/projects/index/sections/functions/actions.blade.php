<div class="card card-primary">
   ...
   <div class="card-body p-1">
      ...
      {{-- @if(Route::currentRouteName() == 'admin.projects.index') --}}
         @can('project-create')
            <a href="{{ route('admin.projects.create') }}" class="btn btn-block btn-outline-success" title="Create Project">
      ...
      @if(Route::currentRouteName() == 'admin.projects.trashed')
         ...
         <form action="{{ route('admin.projects.mass_delete') }}" method="post" class="">
            @csrf
            @method('DELETE')
