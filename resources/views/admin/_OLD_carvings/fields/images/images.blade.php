                        ...
                        <tr>
                           ...
                           <td>
                              <form action="{{ route('carvings.image.delete', $image->id) }}" method="POST" class="float-right m-0 p-0">
                                 {{csrf_field()}}
                                 {{ method_field('DELETE') }}
                                 <input type="hidden" value="{{ $carving->id }}" name="project_id">
                                 <div class="btn-group">
                                    <a href="javascript:;"
                                       data-href="/_projects/{{ $image->carving_id }}/{{ $image->name }}"
                                    ...
                                    @include('admin.carvings.carvings.fields.images.editImageModal')
