<form action="{{ route('admin.homepage.update', $newUser->id) }}" method="POST">
   @csrf
   @method("PUT")
      ...
      <div class="card-body p-2">
         ...
         <div class="row">
            ...
            <div class="form-group col-12">
               ...
               <textarea name="body" id="wysiwyg-small" class="form-control form-control-sm wysiwyg-small">{{ old('body') ?? $newUser->body }}</textarea>
