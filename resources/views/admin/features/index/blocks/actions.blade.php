<div class="card card-primary">
   ...
   <div class="card-body p-1">
      ...
      {{-- @if(Route::currentRouteName() == 'admin.features.index') --}}
         @can('feature-create')
            <a href="{{ route('admin.features.create') }}" class="btn btn-block btn-outline-success" title="Request Feature">
      ...
      @if(Route::currentRouteName() == 'admin.features.index')
         <form action="{{ route('admin.features.mass_destroy') }}" method="post" class="">
            @csrf
            @method('DELETE')
      ...
      @if(Route::currentRouteName() == 'admin.features.trashed')
         ...
         <form action="{{ route('admin.features.mass_delete') }}" method="post" class="">
            @csrf
            @method('DELETE')
