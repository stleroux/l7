...
<div class="card card-primary mb-2">
   ...
   <div class="card-body p-0">
      ...
      <div class="form-row">
         ...
         @include('admin.carvings.forms.fields.images.addImage')
                     ...
                     @foreach($carving->images as $key => $image)
                        <tr>
                           ...
                           <td>
                              ...
                              @include('admin.carvings.forms.fields.images.editImageModal')
...
@include('admin.carvings.forms.fields.images.displayImageModal')
