<div class="card card-primary">
   ...
   <div class="card-body p-1">
      ...
      <a href="{{ route('admin.carvings.index') }}"
         class="btn btn-block btn-default text-left {{ request()->routeIs('admin.carvings.index') ? 'buttonActive' : '' }}">
      ...
      <a href="{{ route('admin.carvings.trashed') }}"
         class="btn btn-block btn-default text-left {{ request()->routeIs('admin.carvings.trashed') ? 'buttonActive' : '' }}">
