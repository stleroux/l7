...
@section('content')
	...
	<form action="{{ route('admin.invoicer.invoiced.store') }}" method="POST">
		@csrf
		
		@include('admin.invoicer.invoiced.create.topbar')
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" name="status" value="Invoiced" class="form-control" readonly >
