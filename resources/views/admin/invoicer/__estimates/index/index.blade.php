...
@section('content')
	...
	@include('admin.invoicer.estimates.index.topbar')
						...
						<tr>
							...
							<td>
								<form action="{{ route('admin.invoicer.invoices.destroy',[$invoice->id]) }}" method="POST" 
									...
									<a href="{{ route('admin.invoicer.estimates.show', $invoice->id) }}" class="btn btn-sm btn-outline-primary" data-toggle="tooltip" title="View Estimate">
										<i class="{{ config('icons.view') }}"></i>
									</a>

									<a href="{{ route('admin.invoicer.estimates.edit', $invoice->id) }}" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit Estimate">
