...
<div class="card card-primary mb-2">
   ...
   <div class="card-body p-0">
      ...
      <div class="form-row">
         ...
         @include('admin.projects.fields.images.addImage')
                     ...
                     @foreach($project->images as $key => $image)
                        <tr>
                           ...
                           <td>
                              ...
                              @include('admin.projects.fields.images.editImageModal')
...
@include('admin.projects.fields.images.displayImageModal')
