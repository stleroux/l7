<div class="row mb-2">
   ...
   <div class="col">
      @if(Route::currentRouteName() == 'admin.projects.materials.index')
         @can('project_finishes-create')
            <a href="{{ route('admin.projects.materials.create') }}" class="btn btn-sm btn-success">
   ...
   <div class="col">
         ...
         <div class="dropdown text-center float-right">
            ...
            <div class="dropdown-menu dropdown-menu-right py-0" aria-labelledby="dropdown-menu">
               @can('project_materials-manage')
                  <a href="{{ route('admin.projects.materials.index') }}" class="dropdown-item bg-light">
                     <i class="{{ Config::get('icons.materials') }}"></i>
                     All Materials
                  </a>
               @endcan
               @can('project_materials-delete')
                  <a href="{{ route('admin.projects.materials.trashed') }}" class="dropdown-item bg-light">
      ...
      @if(Route::currentRouteName() == 'admin.projects.materials.index')
         <form action="{{ route('admin.projects.materials.mass_destroy') }}" method="post" class="float-right p-0 pl-1">
            @csrf
            @method('DELETE')
      ...
      @if(Route::currentRouteName() == 'admin.projects.materials.trashed')
         <form action="{{ route('admin.projects.materials.mass_delete') }}" method="post" class="float-right p-0 pl-1">
            @csrf
            @method('DELETE')
