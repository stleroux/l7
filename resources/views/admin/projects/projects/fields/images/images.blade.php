...
<div class="card card-primary mb-2">
   ...
   <div class="card-body p-0">
      ...
      <div class="form-row">
         ...
         @include('admin.projects.projects.fields.images.addImage')
                              ...
                              <form action="{{ route('projects.image.delete', $image->id) }}" method="POST" class="float-right m-0 p-0">
                                 ...
                                 <div class="btn-group">
                                    <a href="javascript:;"
                                       ...
                                       <i class="{{ Config::get('icons.view') }}"></i>
                                    </a>
                                    ...
                                    @include('admin.projects.projects.fields.images.editImageModal')
...
@include('admin.projects.projects.fields.images.displayImageModal')
