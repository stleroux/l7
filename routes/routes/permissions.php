...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function() {
   Route::get('permissions/restore/{user}', 'PermissionsController@restore')->name('permissions.restore');
   Route::post('permissions/delete/{user}', 'PermissionsController@delete')->name('permissions.delete');
