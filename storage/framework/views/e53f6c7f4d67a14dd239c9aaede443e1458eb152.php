         ...
         <div id="accordion">
            <?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
               <div class="card mb-2 mt-2 card-trans-8">
                  <div class="card-header p-0 m-0 bg-primary" id="heading<?php echo e($faq->id); ?>">
                     <h6 class="mb-0 p-0">
                        <a href="#"
                  ...
                  <div id="collapse<?php echo e($faq->id); ?>" class="collapse bg-primary" aria-labelledby="heading<?php echo e($faq->id); ?>" data-parent="#accordion">
...
<?php echo $__env->make('layouts.UI.app-10-2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\sites\l7\resources\views/UI/blog/faqs.blade.php ENDPATH**/ ?>