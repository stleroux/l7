<div class="card card-primary">
   ...
   <div class="card-body p-1">
      ...
      <?php if(Route::currentRouteName() == 'admin.tags.index'): ?>
         <form action="<?php echo e(route('admin.tags.mass_destroy')); ?>" method="post" class="">
            <?php echo csrf_field(); ?>
      ...
      <?php if(Route::currentRouteName() == 'admin.tags.trashed'): ?>
         ...
         <form action="<?php echo e(route('admin.tags.mass_delete')); ?>" method="post" class="">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/tags/index/sections/functions/actions.blade.php ENDPATH**/ ?>