<div class="card card-primary">
   ...
   <div class="card-body p-1">
         ...
         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('finish-create')): ?>
            <a href="<?php echo e(route('admin.finishes.create')); ?>" class="btn btn-block btn-outline-success" title="Create Finish">
      ...
      <?php if(Route::currentRouteName() == 'admin.finishes.index'): ?>
         <form action="<?php echo e(route('admin.finishes.mass_destroy')); ?>" method="post" class="">
            <?php echo csrf_field(); ?>
      ...
      <?php if(Route::currentRouteName() == 'admin.finishes.trashed'): ?>
         ...
         <form action="<?php echo e(route('admin.finishes.mass_delete')); ?>" method="post" class="">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/finishes/index/sections/functions/actions.blade.php ENDPATH**/ ?>