   ...
   <form action="<?php echo e(route('admin.permissions.storeSingle')); ?>" method="POST">
      ...
      <div class="card card-info">
         ...
         <div class="card-body pt-2">
            ...
            <div class="row">
               <?php echo $__env->make('admin.permissions.fields.name', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
               <?php echo $__env->make('admin.permissions.fields.description', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
