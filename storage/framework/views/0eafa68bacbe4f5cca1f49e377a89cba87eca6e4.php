...
unset($__errorArgs, $__bag); ?>
							...
							<div class="form-group row">
							   ...
							   <div class="col-md-6">
							      <input
							        	id="reasonToRegister"
							        	type="text"
							         class="form-control<?php echo e($errors->has('reasonToRegister') ? ' is-invalid' : ''); ?>"
					...
					<div class="card-footer">
						<?php echo e(__('All fields are required')); ?>.
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.UI.app-fw', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\sites\l7\resources\views/auth/register.blade.php ENDPATH**/ ?>