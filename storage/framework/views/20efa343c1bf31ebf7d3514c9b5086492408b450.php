...
<div class="card card-trans-0 mb-3">
	...
	<div class="card-header p-2 text-light font-weight-bold bg-primary">
			...
			Comments <small>(<?php echo e($project->comments()->count()); ?> total)</small>
		
	</div>

	<div class="card-body card-trans-6 text-dark p-0">
		<?php if($project->comments->count()): ?>
...
<?php /**PATH C:\sites\l7\resources\views/admin/projects/comments.blade.php ENDPATH**/ ?>