<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission-create')): ?>
   <form action="<?php echo e(route('admin.permissions.storeCrud')); ?>" method="POST">
      <?php echo csrf_field(); ?>
      ...
      <input
         type="text"
         name="modelNameCrud"
         class="form-control form-control-sm <?php $__errorArgs = ['modelNameCrud'];
...
<?php endif; ?>
<?php /**PATH C:\sites\l7\resources\views/admin/permissions/create/crud.blade.php ENDPATH**/ ?>