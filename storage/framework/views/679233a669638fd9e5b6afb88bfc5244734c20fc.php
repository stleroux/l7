		...
		<div class="card">
			...
			<?php if($clients->count() > 0): ?>
				<table class="table table-hover table-sm">
					<thead>
						<tr>
							<th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('id','Client ID'));?></th>
					...
					<tbody>
                     ...
                     <td>
                     	<?php echo e($client->invoices->count()); ?>

                     </td>
							<td>
								<div class="float-right">
									<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('invoicer-invoice')): ?>
										<a href="<?php echo e(route('admin.invoicer.invoices.create', $client->id)); ?>" class="btn btn-sm btn-outline-primary">
									...
									<!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('invoicer-client')): ?> -->
										<a href="<?php echo e(route('admin.invoicer.clients.show', $client->id)); ?>" class="btn btn-sm btn-outline-primary">
											<i class="fa fa-eye" aria-hidden="true"></i>
											View
										</a>

										<a href="<?php echo e(route('admin.invoicer.clients.edit', $client->id)); ?>" class="btn btn-sm btn-outline-primary">
											<i class="fa fa-eye" aria-hidden="true"></i>
											Edit
										</a>
									<!-- <?php endif; ?> -->
...
<?php echo $__env->make('layouts.admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/invoicer/clients/index/index.blade.php ENDPATH**/ ?>