...
<div class="card card-primary mb-2">
   ...
   <div class="card-header p-2 <?php echo e(($errors->first('finish')) ? 'bg-danger' : 'card_header'); ?>" id="showAddFinish">
         ...
         <div id="addFinish" class="col-10 offset-1 pt-2" style="display: none;">
            <div class="card card-outline card-primary mb-2">
               ...
               <div class="card-body p-3">
                  <form action="<?php echo e(route('admin.carvings.finish.store', $carving->id)); ?>" method="post">
         ...
         <div id="addFinish" class="col-xs-12 col-md-12">
            <?php if($carving->finishes()->count() > 0): ?>
               <table class="table table-sm table-hover table-striped mb-0">
                  ...
                  <tbody>
                     <?php $__currentLoopData = $carving->finishes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                           <td><?php echo e($key+1); ?></td>
                           <td><?php echo e($value->name); ?> - <?php echo e($value->sheen); ?></td>
                           <td>
                              <form action="<?php echo e(route('admin.carvings.finish.delete', $value->id)); ?>" method="POST" class="float-right m-0 p-0">
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/carvings/forms/fields/finishes/finishes.blade.php ENDPATH**/ ?>