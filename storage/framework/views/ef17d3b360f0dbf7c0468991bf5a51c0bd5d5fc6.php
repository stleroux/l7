<div class="btn-group" style="background-color: #800000">
	...
	<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<a class="dropdown-item p-0 pl-2 text-light" href="<?php echo e(route('recipes.myRecipesGrid', $category->name)); ?>">
			...
			<?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $children): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<a class="dropdown-item card-trans-6 p-0 pl-2" href="<?php echo route('recipes.myRecipesGrid', $children->name); ?>">
...
<?php /**PATH C:\sites\l7\resources\views/UI/recipes/myRecipes/grid/buttons/ddGrid.blade.php ENDPATH**/ ?>