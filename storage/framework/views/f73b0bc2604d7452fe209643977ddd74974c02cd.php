<div class="row-col mb-2 text-right">
   ...
   <a href="<?php echo e(route('bugs.index')); ?>" class="btn btn-sm btn-light border">
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/UI/bugs/create/topbar.blade.php ENDPATH**/ ?>