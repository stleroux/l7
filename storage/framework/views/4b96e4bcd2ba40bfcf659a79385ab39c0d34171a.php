<div class="card card-primary">
   ...
   <div class="card-body p-1">
         ...
         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('project-create')): ?>
            <a href="<?php echo e(route('admin.projects.create')); ?>" class="btn btn-block btn-outline-success" title="Create Project">
      ...
      <?php if(Route::currentRouteName() == 'admin.projects.index'): ?>
         <form action="<?php echo e(route('admin.projects.mass_destroy')); ?>" method="post" class="">
            <?php echo csrf_field(); ?>
      ...
      <?php if(Route::currentRouteName() == 'admin.projects.trashed'): ?>
         ...
         <form action="<?php echo e(route('admin.projects.mass_delete')); ?>" method="post" class="">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/projects/index/sections/functions/actions.blade.php ENDPATH**/ ?>