...
unset($__errorArgs, $__bag); ?>">
						 		<?php $__currentLoopData = $activity->activitiesOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activityOptionKey => $activityOptionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						            <option value="<?php echo e($activityOptionKey); ?>" <?php echo e($activity->activity == $activityOptionValue ? 'selected' : ''); ?>><?php echo e($activityOptionValue); ?></option>
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-md-3 offset-md-3">
						<div class="form-group">
							...
							<input type="text" name="owed" class="form-control" value="<?php echo e($invoice->total); ?>" readonly>
						</div>
					</div>
...
<?php echo $__env->make('layouts.admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/invoicer/activities/create/create.blade.php ENDPATH**/ ?>