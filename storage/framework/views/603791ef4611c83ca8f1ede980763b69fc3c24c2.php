      ...
      <?php if($popular->count() > 0): ?>
         ...
         <ul class="list-group">
            ...
            <?php $__currentLoopData = $popular; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               ...
               <a href="<?php echo e(route('carvings.show', $p->id)); ?>" class="card-trans-2 list-group-item list-group-item-action p-1 <?php echo e((route('carvings.show', $p->id) === url()->current()) ? 'carvingActive' : ''); ?>">
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/UI/carvings/blocks/popular.blade.php ENDPATH**/ ?>