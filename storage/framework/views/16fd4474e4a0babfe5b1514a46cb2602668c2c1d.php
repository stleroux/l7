<div class="row-col mb-2 text-right">
   ...
   <a href="<?php echo e(route('features.index')); ?>" class="btn btn-sm btn-light border">
...
<?php /**PATH C:\sites\l7\resources\views/UI/features/create/topbar.blade.php ENDPATH**/ ?>