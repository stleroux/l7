<div class="row mb-2 float-right">
      ...
      <div class=" px-1">         
         ...
         <form action="<?php echo e(route('admin.movies.mass_destroy')); ?>" method="post" class=" p-0 pl-1">
            <?php echo csrf_field(); ?>
         ...
         <form action="<?php echo e(route('admin.recipes.mass_resetViews')); ?>" method="post" class=" p-0 pl-1">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\sites\l7\resources\views/admin/movies/index/topbar.blade.php ENDPATH**/ ?>