      ...
      <div class="modal-content text-dark">
         <div class="modal-header bg-primary p-2 m-0">
            <h5 class="modal-title" id="exampleModalLongTitle">
               <i class="<?php echo e(config('icons.notification')); ?>"></i>
               Notifications Help
            </h5>
         ...
         <div class="modal-body m-0 p-0">
            ...
            <div class="card m-0 p-0">
               <div class="card-body p-2 m-0">
                  <p>Notification(s) related help content will go here</p>
               </div>
            </div>
...
</div><!-- modal --><?php /**PATH C:\sites\l7\resources\views/admin/notifications/help.blade.php ENDPATH**/ ?>