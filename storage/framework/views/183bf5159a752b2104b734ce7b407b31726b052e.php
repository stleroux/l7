<form action="<?php echo e(route('admin.features.mass_delete')); ?>" method="post">
   <?php echo csrf_field(); ?>
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/posts/actions/mass/delete.blade.php ENDPATH**/ ?>