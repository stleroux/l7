<div class="card">
	...
	<div class="card-header">
		Owing Clients
		<span class="float-right"><small><b>Total :</b> <?php echo e($owingClients->count()); ?></small></span>
	</div>
	...
	<table class="table table-hover table-sm mb-0">
		...
		<?php $__currentLoopData = $owingClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr>
				<td>
					<a href="<?php echo e(route('admin.users.show', $client->id)); ?>">
						<?php echo e($client->last_name); ?>, <?php echo e($client->first_name); ?>
...
</div><?php /**PATH C:\sites\l7\resources\views/admin/invoicer/dashboard/inc/owingClients.blade.php ENDPATH**/ ?>