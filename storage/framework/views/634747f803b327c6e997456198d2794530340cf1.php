	...
	<div class="col-sm-3">
		...
		<div class="form-group <?php echo e($errors->has('paid_at') ? 'has-error' : ''); ?>">
			...
			<div class="input-group">
				...
				<?php else: ?>
					<input type="text" name="paid_at" id="datePicker" value="<?php echo e($invoice->paid_at); ?>" class="form-control" />
				<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/invoicer/invoices/edit/fields/paidDate.blade.php ENDPATH**/ ?>