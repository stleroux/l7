<div class="card mb-2 card-trans-4" style="background-color: #800000">
   ...
   <div class="card-body card-trans-6 p-0 m-0">
      ...
      <a href="<?php echo e(route('recipes.faq')); ?>" class="card-trans-2 list-group-item list-group-item-action p-1">
...
<?php /**PATH C:\sites\l7\resources\views/UI/recipes/blocks/faqs.blade.php ENDPATH**/ ?>