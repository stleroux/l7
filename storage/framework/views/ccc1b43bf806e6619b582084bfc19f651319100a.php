<?php if($paginator->hasPages()): ?>
    ...
    <ul class="pagination pagination-sm float-right pb-1 mb-0 pr-3" role="navigation">
        ...
        <?php if($paginator->onFirstPage()): ?>
            <li class="disabled btn btn-xs btn-info p-2 font-weight-bold">
                <span>First</span>
            </li>
        <?php else: ?>
            <a href="<?php echo e($paginator->toArray()['first_page_url']); ?>">
                <li class="btn btn-xs btn-info p-2 font-weight-bold">
                    First
                </li>
            </a>
        <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/lerouxs/sites/l7/resources/views/UI/projects/pagination/custom.blade.php ENDPATH**/ ?>