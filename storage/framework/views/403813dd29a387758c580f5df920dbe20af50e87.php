      ...
      <div class="modal-content">
         ...
         <div class="modal-header bg-primary">
            <h5 class="modal-title">
               ...
               Approve Multiple <?php echo e($fullName); ?>
         ...
         <form action="<?php echo e(route('admin.'. $action .'.mass_approve')); ?>" method="POST">
            <?php echo csrf_field(); ?>

            <div class="modal-body text-dark">
               <p>Are you sure you want to approve the selected <?php echo e($modelNamePlural); ?>?</p>
            </div>
            ...
            <div class="modal-footer align-items-start">
               ...
               <button type="submit" class="btn btn-primary">Approve <?php echo e($fullName); ?></button>
            </div><!-- Modal Footer -->
         </form>
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/modals/massApprove.blade.php ENDPATH**/ ?>