<?php
      ...
      if(!empty($finaldart)) {
         if(!empty($pouts)){
            echo '
               <div class="card mb-1 card-trans-4">
                  <div class="card-header p-2 text-light">
                     Preferred Outs
                  </div>
                  <table class="table table-hover table-sm card-trans-4 mb-0">
            ';
            foreach($pouts as $out) {
               echo '<tr class="text-dark"><td>'.$out.'</td></tr>';
            }
            echo '</table></div>';
      ...
      if(!empty($everyotherout)) {
         echo '<div class="card mb-1 card-trans-4">
               <div class="card-header p-2 text-light">
                  Every Other Out
               </div>
               <table class="table table-hover table-sm card-trans-4 mb-0">';
      ...
      echo '</table></div>';
    ?><?php /**PATH /home/lerouxs/sites/l7/resources/views/UI/darts/01/inc/possibleOuts.blade.php ENDPATH**/ ?>