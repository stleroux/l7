...
<div class="col-sm-3">
	...
	<div class="form-group <?php echo e($errors->has('estimated_at') ? 'has-error' : ''); ?>">
		...
		<div class="input-group">
			...
			<?php else: ?>
				<input type="text" name="estimated_at" id="datePickerEstimated" value="<?php echo e($invoice->estimated_at); ?>" class="form-control" />
			<?php endif; ?>
...
<?php /**PATH C:\sites\l7\resources\views/admin/invoicer/invoices/edit/fields/estimatedDate.blade.php ENDPATH**/ ?>