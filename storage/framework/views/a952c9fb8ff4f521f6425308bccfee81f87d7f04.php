<ul class="nav nav-tabs justify-content-start">
	<li class="nav-item">
		<a class="nav-link <?php echo e((Request::is('admin/invoicer/ledger') ? 'active' : '')); ?>" href="<?php echo e(route('admin.invoicer.ledger')); ?>">
			...
			All Invoices
			<span class="badge badge-info text-right"><?php echo e(App\Models\InvoicerInvoice::all()->count()); ?></span>
		</a>
	</li>
	<li class="nav-item">
...
</ul><?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/invoicer/ledger/topbar.blade.php ENDPATH**/ ?>