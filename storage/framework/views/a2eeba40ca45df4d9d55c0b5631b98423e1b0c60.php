			...
			<div class="card-body">
				<div class="row">
					<div class="col-sm-8">
						...
						<input type="text" name="product" class="form-control" value="<?php echo e($item->product); ?>" readonly>
...
<?php echo $__env->make('layouts.admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\sites\l7\resources\views/admin/invoicer/invoiceItems/edit/edit.blade.php ENDPATH**/ ?>