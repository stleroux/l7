...
unset($__errorArgs, $__bag); ?>">
								<?php if(!empty($client)): ?>
									<option value="<?php echo e($client->id); ?>" >
										<?php echo e($client->last_name); ?>, <?php echo e($client->first_name); ?> :: <?php echo e($client->email); ?> :: <?php echo e($client->company_name); ?>
								...
								<?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($client->id); ?>" >
										<?php echo e($client->last_name); ?>, <?php echo e($client->first_name); ?> :: <?php echo e($client->email); ?> <?php echo e($client->company_name ? ' :: ' . $client->company_name . '' : ''); ?>
...
<?php echo $__env->make('layouts.admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\sites\l7\resources\views/admin/invoicer/invoices/create.blade.php ENDPATH**/ ?>