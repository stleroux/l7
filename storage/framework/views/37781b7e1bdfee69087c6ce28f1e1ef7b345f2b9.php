...
<div class="card card-primary mb-2">
   ...
   <div class="card-header p-1 <?php echo e(($errors->first('material')) ? 'bg-danger' : 'card_header'); ?>" id="showAddMaterial">
         ...
         <div id="addMaterial" class="col-10 offset-1 pt-2" style="display: none;">
            <div class="card card-outline card-primary mb-2">
               ...
               <div class="card-body p-3">
                  <form action="<?php echo e(route('projects.material.store', $project->id)); ?>" method="post">
         ...
         <div id="addMaterial" class="col-xs-12 col-md-12">
            <?php if($project->materials()->count() > 0): ?>
               <table class="table table-sm table-hover table-striped mb-0">
                  ...
                  <tbody>
                     <?php $__currentLoopData = $project->materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                           <td><?php echo e($key+1); ?></td>
                           <td><?php echo e($value->name); ?></td>
                           <td>
                              <form action="<?php echo e(route('projects.material.delete', $value->id)); ?>" method="POST" class="float-right m-0 p-0">
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/projects/forms/fields/materials/materials.blade.php ENDPATH**/ ?>