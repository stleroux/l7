<div class="card card-primary">
   ...
   <div class="card-body p-1">
      ...
      <a href="<?php echo e(route('admin.posts.unpublished')); ?>"
         class="btn btn-block btn-default text-left <?php echo e(request()->routeIs('admin.posts.unpublished') ? 'buttonActive' : ''); ?>">
         <i class="<?php echo e(config('icons.posts')); ?>"></i>
         Unpublished Posts
         <div class="badge badge-dark badge-pill float-right mt-1">
      ...
      <a href="<?php echo e(route('admin.posts.new')); ?>"
         class="btn btn-block btn-default text-left <?php echo e(request()->routeIs('admin.posts.new') ? 'buttonActive' : ''); ?>">
         <i class="<?php echo e(config('icons.posts')); ?>"></i>
         New Posts
         <div class="badge badge-dark badge-pill float-right mt-1">
      ...
      <a href="<?php echo e(route('admin.posts.future')); ?>"
         class="btn btn-block btn-default text-left <?php echo e(request()->routeIs('admin.posts.future') ? 'buttonActive' : ''); ?>">
         <i class="<?php echo e(config('icons.posts')); ?>"></i>
         Future Posts
         <div class="badge badge-dark badge-pill float-right mt-1">
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/posts/index/blocks/pages.blade.php ENDPATH**/ ?>