...
<?php $__env->startSection('content'); ?>
	...
	<form action="<?php echo e(route('carvings.customOrder.sign.house.material.store')); ?>" method="POST">
		<?php echo csrf_field(); ?>
				...
				<div class="card card-trans-4">
					...
					<div class="card-header card-trans-2 text-dark">
						<div class="card-title font-weight-bold">
							House Number Sign :: Step 3 :: Select the desired wood
						</div>
					</div> <!-- End card header -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.UI.app-10-2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\sites\l7\resources\views/UI/carvings/customOrders/signs/houses/material.blade.php ENDPATH**/ ?>