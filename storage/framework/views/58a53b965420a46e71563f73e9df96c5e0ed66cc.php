   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content text-dark">
         ...
         <div class="modal-body">
            <form action="<?php echo e(route('admin.carvings.image.update', $image->id)); ?>" method="post" >
               <?php echo csrf_field(); ?>
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/carvings/forms/fields/images/editImageModal.blade.php ENDPATH**/ ?>