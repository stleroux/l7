											...
											<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('invoicer-product')): ?>
												<td>
													<form action="<?php echo e(route('admin.invoicer.products.destroy', [$product->id])); ?>" method="POST" onsubmit="return confirm('Do you really want to delete this product?');" class="float-right">
														...
														<a href="<?php echo e(route('admin.invoicer.products.show', $product->id)); ?>" class="btn btn-sm btn-outline-primary">
															<i class="fa fa-eye"></i>
															View
														</a>

														<a href="<?php echo e(route('admin.invoicer.products.edit', $product->id)); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/invoicer/products/index/index.blade.php ENDPATH**/ ?>