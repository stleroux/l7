<div class="card card-primary">
   ...
   <div class="card-body p-1">
      ...
      <?php if(Route::currentRouteName() == 'admin.carvings.trashed'): ?>
         <?php echo $__env->make('admin.carvings.actions.mass.restore', ['modelName'=>'carving'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         <?php echo $__env->make('admin.carvings.actions.mass.delete', ['modelName'=>'carving'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php endif; ?>
