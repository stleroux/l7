      ...
      <select class="form-control form-control-sm select2" data-style="btn-sm btn-light" id="tags" name="tags[]" multiple >
         ...
         <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(last(request()->segments()) === 'edit'): ?>
               <option value="<?php echo e($tag->id); ?>" <?php echo e($carving->tags->contains($tag->id) ? "selected='selected" : ""); ?>><?php echo e($tag->name); ?></option>               
            <?php endif; ?>
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/carvings/forms/fields/general/tags.blade.php ENDPATH**/ ?>