	...
	<div class="form-group <?php echo e($errors->has('logged_at') ? 'has-error' : ''); ?>">
		...
		<div class="input-group">
			...
			<?php if($invoice->logged_at || $invoice->status == 'paid'): ?>
				<input type="text" name="created_at" value="<?php echo e($invoice->logged_at); ?>" class="form-control" readonly />
			<?php else: ?>
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/invoicer/invoices/edit/fields/loggedDate.blade.php ENDPATH**/ ?>