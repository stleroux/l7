<div class="card card-trans-0 mb-3">
	...
	<div class="card-header p-2 text-light font-weight-bold bg-primary">
			...
			Comments <small>(<?php echo e($carving->comments()->count()); ?> total)</small>
		
	</div>

	<div class="card-body card-trans-6 text-dark p-0">
		<?php if($carving->comments->count()): ?>
			<table class="table table-sm table-hover mb-0">
				...
				<tbody>
					<?php $__currentLoopData = $carving->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr scope="row">
						<td>
...
<?php /**PATH C:\sites\l7\resources\views/admin/carvings/comments.blade.php ENDPATH**/ ?>