...
<?php $__env->startSection('content'); ?>
	...
	<form action="<?php echo e(route('carvings.customOrder.sign.house.pattern.store')); ?>" method="POST">
		<?php echo csrf_field(); ?>
			...
			<div class="col">
				...
				<div class="card card-trans-4">
					...
					<div class="card-body">
						...
						<div class="row text-center">
							<label class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 col-h">
								...
								<div><input type="radio" name="pattern" id="1" value="1" <?php echo e(Session::get('pattern') == "1" ? 'checked' : ''); ?> /></div>
							</label>
							<label class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 col-h">
								<div class="mb-1">Design 2</div>
								<div><img src="<?php echo e(asset('customOrders/signs/patterns/pattern_2.png')); ?>" class="img-fluid" /></div>
								<div><input type="radio" name="pattern" id="2" value="2" <?php echo e(Session::get('pattern') == "2" ? 'checked' : ''); ?> /></div>
							</label>
							<label class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 col-h">
								<div class="mb-1">Design 3</div>
								<div><img src="<?php echo e(asset('customOrders/signs/patterns/pattern_3.png')); ?>" class="img-fluid" /></div>
								<div><input type="radio" name="pattern" id="3" value="3" <?php echo e(Session::get('pattern') == "3" ? 'checked' : ''); ?> /></div>
							</label>
							<label class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 col-h">
								<div class="mb-1">Design 4</div>
								<div><img src="<?php echo e(asset('customOrders/signs/patterns/pattern_4.png')); ?>" class="img-fluid" /></div>
								<div><input type="radio" name="pattern" id="4" value="4" <?php echo e(Session::get('pattern') == "4" ? 'checked' : ''); ?> /></div>
							</label>
						</div>
					...
					<div class="card-footer">
						<div class="row">
							<div class="col">
								<a type="button" href="<?php echo e(route('carvings.customOrder.sign.house.material.create')); ?>" class="btn btn-warning">
...
<?php echo $__env->make('layouts.UI.app-10-2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\sites\l7\resources\views/UI/carvings/customOrders/signs/houses/pattern.blade.php ENDPATH**/ ?>