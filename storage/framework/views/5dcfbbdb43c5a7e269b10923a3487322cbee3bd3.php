<form action="<?php echo e(route('admin.tags.mass_delete')); ?>" method="post">
   <?php echo csrf_field(); ?>
...
<?php /**PATH /home/lerouxs/sites/l7/resources/views/admin/tags/actions/mass/delete.blade.php ENDPATH**/ ?>