<div class="card card-primary">
   ...
   <div class="card-body p-1">
      ...
      <?php if(Route::currentRouteName() == 'admin.faqs.index'): ?>
         <?php echo $__env->make('admin.actions.mass.publish', ['modelName'=>'faq'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         <?php echo $__env->make('admin.actions.mass.unpublish', ['modelName'=>'faq'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
