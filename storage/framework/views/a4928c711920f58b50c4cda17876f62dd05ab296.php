                        ...
                        <div class="position-relative p-0">
                           ...
                           <div class="h-100 thumbnail pt-2 text-center" >
                              <a href="<?php echo e(route('projects.show', $project->id)); ?>">
                                 ...
                                 <div class=""><strong>Category</strong> : <?php echo e($project->category); ?></div>
                                 <div class=""><strong>Views</strong> : <?php echo e($project->views); ?></div>
                                 <div class=""><strong>Comments</strong> : <?php echo e($project->comments->count()); ?></div>
                                 <div class="">
                                    <span>
                                       <strong>
...
<?php echo $__env->make('layouts.UI.app-10-2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lerouxs/sites/l7/resources/views/UI/projects/index.blade.php ENDPATH**/ ?>